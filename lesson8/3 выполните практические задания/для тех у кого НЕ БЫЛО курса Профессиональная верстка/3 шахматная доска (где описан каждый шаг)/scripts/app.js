let app = {
    ...
    insertPawns() {
        ...
        let whitePawnsRow = document.querySelector('tbody').childNodes[6].querySelectorAll('td');
        ...
        let blackPawnsRow = document.querySelector('tbody').childNodes[1].querySelectorAll('td');
     ...
     */
    generateBoard() {
        // 3. создаем переменную board и присваиваем ей пустую строку, в ней будет храниться разметка 
        //игрового поля в виде строки
        let board = '';

        // 3.1 создаем переменную rowStartWithColor, в которой укажем, что линия на игровом поле 
        // будет начинаться с белого цвета т.е. присваиваем строку "white"
