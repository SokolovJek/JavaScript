...
allButtonEl.forEach(function (el) {
...
function handleClick(clickedButtonEvent) {
    let buttonClick = clickedButtonEvent.target;

    // // 2. из объекта события получите ссылку на .product и
    // // сохраните в переменную:
    // // const cardNode = ;
    const cardNode = buttonClick.parentElement;
...
function showMoreText(card) {
    ...
    let text = 'Здесь описание товара.........<br>Здесь описание товара.........<br>';
